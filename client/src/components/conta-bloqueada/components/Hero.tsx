...
export default function Hero() {
  return (
    <section className="hero">
      <div className="wrap">
        <h1>
          Sua conta foi bloqueada ou seu dinheiro foi <em>retido</em>?
        </h1>
        <p className="sub">
          Um advogado pode ajudar você a entender o motivo do bloqueio e
          quais medidas podem ser avaliadas — sem custo para conversar.
        </p>
