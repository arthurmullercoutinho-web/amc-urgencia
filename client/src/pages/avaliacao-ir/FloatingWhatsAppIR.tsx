...
export default function FloatingWhatsAppIR({ onWhatsAppClick }: FloatingWhatsAppIRProps) {
  return (
    <a
      ...
      className="fixed bottom-[calc(16px+env(safe-area-inset-bottom))] right-[calc(16px+env(safe-area-inset-right))] z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#128038] shadow-[0_8px_20px_rgba(18,128,56,0.45)] transition-colors hover:bg-[#0f6b2f] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
    >
